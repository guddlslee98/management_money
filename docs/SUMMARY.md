...
| 규모 | TypeScript/TSX 130개 파일 · 약 12,700줄 · 커밋 43개 · 단위·화면 테스트 178개 · 브라우저 E2E 검사 21개 |
...
| 단위·화면 테스트 | **178개 통과** (도메인 계산, 저장소, 기본 카테고리 일관성, 가져오기 파서 38개, 화면 렌더 테스트) — 부하 상황 3회 연속 통과 |
